...
model_data["lambda_loss"] = np.array([1e4, 1e2, 1e1, 1e0, 0]) * 1
...
model_data["model_filename"] = "RVINO_hyperelasticityVessel_s{}_n{}_ep{}.pth".format(
...
plt.savefig( folder + '/Vessel_TrainingTrend.png', dpi=300, bbox_inches='tight')
plt.show()
...
phi12 = x_input.unsqueeze(0)[:, ::2, ::2, 0:2]
phi_grid = phi12[..., 0:1] * phi12[..., 1:2]
