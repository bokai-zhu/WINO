...
model_data["model_filename"] = "FNO_Grad_hyperelasticity_ellip_s{}_n{}_ep{}.pth".format(
...
t1 = default_timer()
train_l2_log, test_l2_log = train_fno_hyperelasticity_DBC_Guass(
