...
from Phi_FEM.generate_data_Arbit import solve_only as phi_fem_solve_only
...
model_data["model_filename"] = "RVINO_hyperelasticity_arbit_s{}_n{}_ep{}.pth".format(
...
os.makedirs(folder, exist_ok=True)
nw_png = "Arbit_NewtonResidual.png"
...
box_png = "Arbit_GMRESIters_boxplot.png"
