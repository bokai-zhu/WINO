...
model_data["model_filename"] = "RVINO_Data_hyperelasticityTrapezoid_y{}x{}_n{}_ep{}.pth".format(
...
t1 = default_timer()
train_l2_log, test_l2_log, *_ = train_rvino_hyperelasticity_trapezoid_Guass(
