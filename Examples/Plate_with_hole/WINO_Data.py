...
model_data["lambda_loss"] = np.array([1e5, 1e2, 1e-2, 1e0]) * 0.01
...
model_data["model_filename"] = "RVINO_Data_hyperelasticity_hole_s{}_n{}_ep{}.pth".format(
