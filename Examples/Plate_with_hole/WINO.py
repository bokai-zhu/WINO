...
model_data["lambda_loss"] = np.array([1e5, 1e2, 1e-2, 1e0]) * 0.1
...
t1 = default_timer()
train_l2_log, test_l2_log = train_rvino_hyperelasticity_Guass(
...
plt.xlabel(r'Epoch')
plt.savefig( folder + '/Hole_TrainingTrend.png', dpi=300, bbox_inches='tight')
plt.show()
